...
// Type: Facturacion.WSAfip.regimen
...
namespace Facturacion.WSAfip
{
  ...
  [Serializable]
  public class regimen : INotifyPropertyChanged
  {
    ...
    public string descripcionRegimen
    {
      ...
      set
      {
        ...
        this.RaisePropertyChanged(nameof (descripcionRegimen));
      }
    }
    ...
    public int idRegimen
    {
      ...
      set
      {
        ...
        this.RaisePropertyChanged(nameof (idRegimen));
      }
    }
    ...
    public bool idRegimenSpecified
    {
      ...
      set
      {
        ...
        this.RaisePropertyChanged(nameof (idRegimenSpecified));
      }
    }
    ...
    public string tipoRegimen
    {
      ...
      set
      {
        ...
        this.RaisePropertyChanged(nameof (tipoRegimen));
      }
    }
